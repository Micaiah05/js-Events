...
function moreTrees(){
    var trees = document.createElement('p');
    trees.id = 'text';
    trees.innerHTML = "Let's put some happy little bushes on the other side now. Anything you want to do you can do here. Trees cover up a multitude of sins. If you don't like it - change it. It's your world. Maybe there's a happy little waterfall happening over here."
    nirvana.appendChild(trees); 
}
...
function displayMissing(){
    var missingli = document.createElement('li');
    missingli.class = 'mix';
    missingli.innerHTML = '1 good ol\' beet'
